...
static void CalculateWaterDisplacement(float & fTu, float & fTv, EERIEPOLY * ep,
	...
	switch(step) {
	case(0):fTu = FluidTextureDisplacement(true, ep->v[vertIndex].p, time, 1000, 200, 1000, 32); 
			fTv = FluidTextureDisplacement(false, ep->v[vertIndex].p, time, 1000, 200, 1000, 32); 
			break;
	case(1):fTu = FluidTextureDisplacement(true, ep->v[vertIndex].p, time, 1000, 200, 1000, 28, 30.f, 30); 
			fTv = FluidTextureDisplacement(false, ep->v[vertIndex].p, time, 1000, 200, 1000, 28, 30.f, 30, -1.0); 
			break;
	case(2):fTu = FluidTextureDisplacement(true, ep->v[vertIndex].p, time, 1000, 200, 1000, 40, 60.f, 60, -1.0);
			fTv = FluidTextureDisplacement(false, ep->v[vertIndex].p, time, 1000, 200, 1000, 40, 60.f, 60, -1.0);
			break;
	default:break;
	}
}
...
static void CalculateLavaDisplacement(float & fTu, float & fTv, EERIEPOLY * ep,
                                      float time, int vertIndex, int step) {
	switch(step) {
	case(0):fTu = FluidTextureDisplacement(true, ep->v[vertIndex].p, time, 1000, 200, 2000, 20); 
			fTv = FluidTextureDisplacement(false, ep->v[vertIndex].p, time, 1000, 200, 2000, 20); 
			break;
	case(1):fTu = FluidTextureDisplacement(true, ep->v[vertIndex].p, time, 1000, 100, 2000, 10); 
			fTv = FluidTextureDisplacement(false, ep->v[vertIndex].p, time, 1000, 100, 2000, 10);
			break;
	case(2):fTu = FluidTextureDisplacement(true, ep->v[vertIndex].p, time, 600, 160, 2000, 11); 
			fTv = FluidTextureDisplacement(false, ep->v[vertIndex].p, time, 600, 160, 2000, 11);
			break;
	default:break;
	}
}
